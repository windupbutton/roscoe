...
{
    public abstract class SqlServerUpdateBase<T> : RoscoeCommand<T>, IWrapper<UpdateClause>, IWrapper<JoinClause>, IWrapper<WhereClause>
    {
        ...
        public SqlServerUpdateBase(IServiceProvider serviceProvider, Table table) : base(serviceProvider)
        {
            ...
            fromClause.TableSource = table;
        }

        protected SqlServerUpdateBase(IServiceProvider serviceProvider, UpdateClause updateClause, FromClause fromClause, JoinClause joinClause, WhereClause whereClause)
