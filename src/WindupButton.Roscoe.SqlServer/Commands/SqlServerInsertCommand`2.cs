...
{
    public class SqlServerInsertCommand<TColumns, TResult> : SqlServerInsertBase<TColumns, IEnumerable<TResult>>
    {
        private readonly SqlServerOutputClause<TResult> SqlServerOutputClause;

        public SqlServerInsertCommand(IServiceProvider serviceProvider, SqlServerInsertCommand<TColumns> command)
        ...
        protected SqlServerQueryCommand<TColumns> Values { get; }
