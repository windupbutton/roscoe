...
{
    public abstract class SqlServerInsertBase<TColumns, TResult> : RoscoeCommand<TResult>, IWrapper<InsertClause<TColumns>>, IWrapper<OnConflictClause>
    {
        public SqlServerInsertBase(IServiceProvider serviceProvider, Table table, TColumns expression)
        ...
        protected SqlServerInsertBase(IServiceProvider serviceProvider, InsertClause<TColumns> insertClause, OnConflictClause onConflictClause)
            : base(serviceProvider)
        {
