...
{
    public class SqlServerUpdateCommandFactory : ISqlServerUpdateCommandFactory
    {
        public virtual SqlServerUpdateCommand Create(IServiceProvider serviceProvider, Table table)
        {
            return new SqlServerUpdateCommand(serviceProvider, table);
        }
