...
{
    public abstract class SqlServerDeleteBase<T> : RoscoeCommand<T>, IWrapper<DeleteClause>, IWrapper<FromClause>, IWrapper<JoinClause>, IWrapper<WhereClause>
    {
        ...
        public SqlServerDeleteBase(IServiceProvider serviceProvider, Table table)
        ...
        protected SqlServerDeleteBase(IServiceProvider serviceProvider, DeleteClause deleteClause, FromClause fromClause, JoinClause joinClause, WhereClause whereClause)
            : base(serviceProvider)
        {
