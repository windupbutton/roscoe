...
{
    public class ArrayColumn<T> : DbArray<T>, IColumn
    //where T : IDbFragment
    {
        private readonly IDictionary<string, object> properties;

        public ArrayColumn(IDictionary<string, object> properties)
        {
        ...
        public static implicit operator ArrayColumn<T>(ColumnBuilder<IEnumerable<T>> columnBuilder)
        {
            return new ArrayColumn<T>(columnBuilder.Properties);
        }
    }
}
