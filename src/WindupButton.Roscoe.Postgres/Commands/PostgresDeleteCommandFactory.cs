...
{
    public class PostgresDeleteCommandFactory : IPostgresDeleteCommandFactory
    {
        public virtual PostgresDeleteCommand Create(IServiceProvider serviceProvider, Table table)
        {
            return new PostgresDeleteCommand(serviceProvider, table);
        }
