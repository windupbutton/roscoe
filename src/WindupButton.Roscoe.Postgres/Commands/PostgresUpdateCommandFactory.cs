...
{
    public class PostgresUpdateCommandFactory : IPostgresUpdateCommandFactory
    {
        public virtual PostgresUpdateCommand Create(IServiceProvider serviceProvider, Table table)
        {
            return new PostgresUpdateCommand(serviceProvider, table);
        }
