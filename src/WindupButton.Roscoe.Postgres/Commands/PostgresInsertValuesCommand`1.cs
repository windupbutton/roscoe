...
{
    public class PostgresInsertValuesCommand<T> : PostgresInsertBase<T, DbCommandResult>, IWrapper<PostgresInsertValuesCommand<T>>, IWrapper<ValuesClause<T>>
    {
        private readonly ValuesClause<T> valuesClause;
        ...
        PostgresInsertValuesCommand<T> IWrapper<PostgresInsertValuesCommand<T>>.Value => this;
