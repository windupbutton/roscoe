...
{
    public class PostgresInsertCommand<T> : PostgresInsertBase<T, DbCommandResult>
    {
        public PostgresInsertCommand(IServiceProvider serviceProvider, Table table, T expression)
