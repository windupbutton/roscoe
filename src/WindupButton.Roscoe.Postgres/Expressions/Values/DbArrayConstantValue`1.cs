...
{
    public class DbArrayConstantValue<T> : DbArray<T>
    {
        private readonly IEnumerable enumerable;

        public DbArrayConstantValue(IEnumerable enumerable)
        {
        ...
        {
            new ArrayLiteral(enumerable).Build(builder, serviceProvider);
        }
    }
}
