...
{
    public class StringColumn : DbString, IColumn
    {
        private readonly IDictionary<string, object> properties;

        public StringColumn(IDictionary<string, object> properties)
        {
        ...
        public static implicit operator StringColumn(ColumnBuilder<string> columnBuilder)
        {
            return new StringColumn(columnBuilder.Properties);
        }

        public static implicit operator StringColumn(string value)
        {
