...
{
    public class DateTimeColumn : DbDateTime, IColumn
    {
        private readonly IDictionary<string, object> properties;

        public DateTimeColumn(IDictionary<string, object> properties)
        {
        ...
        public static implicit operator DateTimeColumn(ColumnBuilder<DateTime> columnBuilder)
        {
            return new DateTimeColumn(columnBuilder.Properties);
        }
    }
}
