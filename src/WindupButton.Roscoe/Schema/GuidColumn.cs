...
{
    public class GuidColumn : DbGuid, IColumn
    {
        private readonly IDictionary<string, object> properties;

        public GuidColumn(IDictionary<string, object> properties)
        {
        ...
        public static implicit operator GuidColumn(ColumnBuilder<Guid> columnBuilder)
        {
            return new GuidColumn(columnBuilder.Properties);
        }

        public static implicit operator GuidColumn(Guid value)
        {
