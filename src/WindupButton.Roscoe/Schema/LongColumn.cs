...
{
    public class LongColumn : DbLong, IColumn
    {
        private readonly IDictionary<string, object> properties;

        public LongColumn(IDictionary<string, object> properties)
        {
        ...
        public static implicit operator LongColumn(ColumnBuilder<long> columnBuilder)
        {
            return new LongColumn(columnBuilder.Properties);
        }
    }
}
