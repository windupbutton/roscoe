...
{
    public class ByteArrayColumn : DbByteArray, IColumn
    {
        private readonly IDictionary<string, object> properties;

        public ByteArrayColumn(IDictionary<string, object> properties)
        {
        ...
        public static implicit operator ByteArrayColumn(ColumnBuilder<byte[]> columnBuilder)
        {
            return new ByteArrayColumn(columnBuilder.Properties);
        }
    }
}
