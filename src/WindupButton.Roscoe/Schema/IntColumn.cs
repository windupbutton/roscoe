...
{
    public class IntColumn : DbInt, IColumn
    {
        private readonly IDictionary<string, object> properties;

        public IntColumn(IDictionary<string, object> properties)
        {
        ...
        public static implicit operator IntColumn(ColumnBuilder<int> columnBuilder)
        {
            return new IntColumn(columnBuilder.Properties);
        }
    }
}
